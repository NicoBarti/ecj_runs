...
public class MyStatistics extends Statistics {
    ...
    double best_val = ((IntegerVectorIndividual)state.population.subpops.get(0).individuals.get(0)).fitness.fitness();
    	for(int y=1;y<state.population.subpops.get(0).individuals.size();y++)
            ...
            double val = ((IntegerVectorIndividual)state.population.subpops.get(0).individuals.get(y)).fitness.fitness();
